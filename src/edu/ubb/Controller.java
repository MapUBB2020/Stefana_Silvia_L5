...
public class Controller implements Initializable {
    ...
    public void nextQuestion(Quiz quiz) {
        ...
        //i += 1;
        //Creating a scene object
        Scene scene2 = new Scene(new Group(), 900, 700);
        if (quiz.getQuestionNumber() < 25) {
            ...
            Label question1 = new Label(")  " + quiz.getQuestions().get(0).getQuestion());
            ...
            //VBox answerBox = answer1+2+3
            Label answer11 = new Label(quiz.getQuestions().get(0).getAnswers().get(0));
            ...
            Label answer21 = new Label(quiz.getQuestions().get(0).getAnswers().get(1));
            ...
            Label answer31 = new Label(quiz.getQuestions().get(0).getAnswers().get(2));
            ...
            answerBox1.getChildren().addAll(answer11, answer21, answer31);
            ...
            myVBox1.getChildren().addAll(headerBox1, questionBox1, answerBox1, buttonAnswBox1, buttonOptBox1);
